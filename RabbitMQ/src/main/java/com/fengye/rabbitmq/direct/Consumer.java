package com.fengye.rabbitmq.direct;
...
/**
 * @Description: 说明direct模式下，这里使用rabbitmq web界面的方式先对图形queue已经进行了交换机类型的绑定
 * @Author: huang
...
public class Consumer implements Runnable {
    ...
    public static void main(String[] args) {
        new Thread(()-> new Consumer().run(), "myqueue1").start();
       // new Thread(()-> new Consumer().run(), "queue2").start();
    }
}
